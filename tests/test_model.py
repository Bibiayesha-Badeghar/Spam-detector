...
class TestModelLoading:
    ...
    def test_vectorizer_loads_successfully(self):
        ...
        try:
            ...
            ), "Vectorizer missing transform method"
        except Exception as e:
...
class TestPrediction:
    ...
    def test_prediction_returns_binary_class(
        self, sample_spam_emails, sample_ham_emails
    ):
    ...
    def test_vectorizer_transform_shape(self, sample_spam_emails):
        ...
        assert X.shape[0] == len(
            sample_spam_emails
        ), "Vectorizer output row count mismatch"
        assert X.shape[1] > 0, "Vectorizer produced no features"

    def test_multiple_emails_batch_prediction(
        self, sample_spam_emails, sample_ham_emails
    ):
...
class TestModelMetrics:
    ...
    def test_model_has_feature_importance(self):
        ...
        ), "Model missing feature importances"
